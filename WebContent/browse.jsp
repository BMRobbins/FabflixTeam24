...
<body>
	...
	<div class="container text-center col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-10">
		<div class="row text-center col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
				<div class="jumbotron col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9 text-center">
					
						<h1>Browse by Genre</h1>
						<img class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left"src="imgs/drama.png" width="180" height="300" class="d-inline-block align-top" alt="">
			    		<br>
			    		<a class="btn fabBlue" role="button" href="browseByGenre.jsp">Browse by Genre</a>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
					<div class="jumbotron col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9 text-center">
			    		...
			    		<br>
			    		<a class="btn fabBlue" role="button" href="browseByTitle.jsp">Browse by Title</a>
				   </div>
			 </div>
		</div>
	</div>
