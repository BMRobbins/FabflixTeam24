...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<link rel="stylesheet" type="text/css" href="browseByGenre.css"/>
			...
			<div class="container text-center">
					<div class="row text-center"> 
			    		...
			    		<%
						    ...
						    String query = "SELECT g.name FROM genres AS g;";
						    PreparedStatement ps = dbCon.prepareStatement(query);
						    ResultSet resultSet = ps.executeQuery();
						    
						    while (resultSet.next()) {
						    String Genre = resultSet.getString("g.name");
						    out.println("<a class=\"btn fabBlue link-margin\" role=\"button\" href=\"movieListBrowse.jsp?Genre="+ Genre +"\">" + Genre + "</a>");						    }
			    		%>
