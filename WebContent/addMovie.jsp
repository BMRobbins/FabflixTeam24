...
<body>
	<%
		...
		if(session.getAttribute("addMovie") != null)
		{
			String message = (String)session.getAttribute("addMovie");
			out.println("<script type=\"text/javascript\">");
			out.println("alert('" + message + "');");
			out.println("</script>");
			session.removeAttribute("addMovie");
		...
		<div class="row text-center"> 
			<div class="jumbotron col-xl-6 col-lg-6 col-md-8 col-sm-10 col-xs-10 text-center">
				<form method="post" action="AddMovie">
		    		...
		    		<input class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-xs-6" type="text" placeholder="Title" name="title" required>
		    		<br>
		    		<label class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4  text-left"><b>Year:</b></label>
		    		<input class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-xs-6" type="number" placeholder="Enter Year" name="year" required>
		    		<br>
		    		<label class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4  text-left"><b>Director:</b></label>
		    		<input class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-xs-6" type="text" placeholder="Enter Director" name="director" required>
		    		<br>
		    		<label class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4  text-left"><b>Star Name:</b></label>
		    		<input class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-xs-6" type="text" placeholder="Enter Star Name" name="starname" required>
		    		<br>
		    		<label class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4  text-left"><b>Genre:</b></label>
		    		<input class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-xs-6" type="text" placeholder="Enter Genre Name" name="genrename" required>
		    		<br>
